...
public class DialogSettingPembelian extends javax.swing.JDialog {
    ...
    public DialogSettingPembelian(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
